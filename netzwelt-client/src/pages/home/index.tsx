...
const Home = () => {
  ...
  return (
    <div className=" w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 h-fit mt-52">
      <h1 className="font-bold text-1xl ">Territories</h1>
      <small>Here are the list of territories</small>
      
      {!loading ? 
      territories.filter((item: any,index:any) =>index < 5).map(function(item: any,index:any){return(
